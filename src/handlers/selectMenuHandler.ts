 ...
 */
async function buildMainShopEmbed(guildId: string, guildName: string): Promise<any> {
 ...
 */
async function buildProductPreviewEmbed(guildId: string, product: any): Promise<any> {
